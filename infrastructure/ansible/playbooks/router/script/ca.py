...
class CertificateWrapper:
    ...
    def add_contents_to_xml(self, root: ET.Element, refid: str = None) -> str:
        ...
        if self.refid is None:
            self.refid = cryptography_helpers.get_php_uniqid()
        refid_xml.text = self.refid
...
class CertificateAuthority:
    ...
    def generate_cert(
        ...
        Parameters:
            ...
            server_cert : bool
                True if server certificate, False if client cert (default: True).
        Returns:
            int :
    ...
    def add_to_xml_root(self, root: ET.Element) -> None:
        ...
        if is_new_ca:
            ...
            self.certificate.add_contents_to_xml(ca_xml)
        ...
        for cert in self.certs:
            ...
            _ = cert.add_contents_to_xml(cert_xml, cert.refid)
        ...
        serial_xml.text = str(len(self.certs))
    ...
    def create(
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            return CertificateAuthority(
                certificate, certs=None, refid=certificate.refid
            )
